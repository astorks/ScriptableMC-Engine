...
export class YamlConfiguration {
	...
	constructor() {
		return new YamlConfiguration.$javaClass();
	}
	public static new0(): YamlConfiguration {
		return new YamlConfiguration.$javaClass();
	}
	public static loadConfiguration(arg0: any): YamlConfiguration {
		return YamlConfiguration.$javaClass.loadConfiguration(arg0);
	}
	public static loadConfiguration0(arg0: any): YamlConfiguration {
		return YamlConfiguration.$javaClass.loadConfiguration(arg0);
	}
	public static createPath(arg0: ConfigurationSection, arg1: string, arg2: ConfigurationSection): string {
		return YamlConfiguration.$javaClass.createPath(arg0, arg1, arg2);
	}
	public static createPath0(arg0: ConfigurationSection, arg1: string): string {
		return YamlConfiguration.$javaClass.createPath(arg0, arg1);
	}
}
